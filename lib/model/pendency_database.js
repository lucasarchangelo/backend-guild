...
const Pendency = mongoose.model('Event', schemas.PendencySchema);
...
const Database = {
    ...
    createPendency: function (pendency, callback) {
      ...
      listByGame: function (game, callback) {
        Pendency.find({game: game},{},{}, (err, pendencies) => {
          if (err) {
      ...
      excludePlayerPendency: function (pendency, callback) {
        ...
        deleteEvent: function (pendencyId, callback) {
